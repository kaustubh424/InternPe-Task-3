...
function ReadToDoItems() {
    todo.forEach((element) => {
      ...
      ${style === ""
                ? ""
                : '<img class="todo-controls" src="https://creazilla-store.fra1.digitaloceanspaces.com/emojis/42428/check-mark-emoji-clipart-md.png" />'
            }</div><div>
      ${style === ""
                ? '<img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="https://th.bing.com/th/id/OIP.5fJ77V6gzsyR4B3KmDNQogHaHa?rs=1&pid=ImgDetMain" />'
                : ""
            }
      <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="https://cdn-icons-png.flaticon.com/128/1214/1214428.png" /></div></div>`;
        li.innerHTML = todoItems;
        listItems.appendChild(li);
    });
}
